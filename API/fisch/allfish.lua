...
return {
	...
	Scylla = {
		...
		Rarity = "Secret";
		Resilience = 1;
		Description = "A mythological, multi-headed being said to lurk in the oceanâ€™s deepest abyss. Its serpent-like heads move independently, striking prey with razor-toothed maws, and some believe they regenerate when severed. A myth to most, it is feared as an immortal guardian of the sea, appearing only in the deadliest storms to drag the unwary into the depths.";
		Hint = "???";
		FavouriteBait = "Shark Head";
		FavouriteTime = nil;
		Price = 200000;
	...
	["Slain Maw"] = {
		...
		Seasons = {"None"};
		Weather = {"None"};
		Quips = {"ðŸŽµ", "ðŸŽ¼", "ðŸŽ¹", "ðŸŽº", "ðŸŽ¸", "ðŸŽ·"};
	...
	Moonstone = {
		...
		From = "Ancient Isle";
		FromMeteor = true;
		Evaluation = "Moonstone's hard, ethereal glowâ€”caused by light scattering within its layersâ€”, often associated with the lunar energy from our lovely moon.";
	};
	["Lapis Lazuli"] = {
		WeightPool = {4, 14};
		Chance = 0;
	...
	["Corsair Grouper"] = {
		...
		Rarity = "Common";
		Resilience = 100;
		Description = "The Corsair Grouper is a resilient, bulky fish, often hiding among shores. Known for its powerful bites, itâ€™s a decent challenge for beginners.";
	...
	["Cursed Eel"] = {
		...
		Resilience = 15;
		ProgressEfficiency = 0.5;
		Description = "Cursed Eels linger in darker waters, giving off an eerie glow. Theyâ€™re a spooky find for night anglers.";
	...
	["Golden Seahorse"] = {
		...
		Rarity = "Mythical";
		Resilience = 10;
		Description = "Golden Sea Horses are small but enchanting, drifting near seaweed & algae. Gentle and rare, theyâ€™re a delight to find.";
	...
	Leedsichthys = {
		...
		Resilience = 30;
		ProgressEfficiency = 0.75;
		Description = "Leedsichthys is a colossal, plankton-feeding fish from the Jurassic period, approximately 165â€“150 million years ago. It is one of the largest fish ever to exist, showcasing the diversity of prehistoric marine life.";
	...
	["Song of the Deep"] = {
		...
		Seasons = {"None"};
		Weather = {"None"};
		Quips = {"I feel it's power..", "Woah.. An Song of the Deep??", "An Song of the Deep!!", "I caught an Song of the Deep!"};
		SparkleColor = Color3.fromRGB(228, 160, 255);
		HoldAnimation = fish:WaitForChild("small");
		HideInBestiary = true;
		From = "None";
	...
	Anchovy = {
		...
		Hint = "Caught in all saltwaterâ€™s of Moosewood";
		FavouriteBait = "None";
		FavouriteTime = "Day";
		Price = 30;
		XP = 20;
	...
	Bluegill = {
		...
		Hint = "Found in saltwaterâ€™s near Snowcap.";
		FavouriteBait = "Insect";
		FavouriteTime = nil;
		Price = 60;
		XP = 90;
	...
	Wiifish = {
		...
		Resilience = 40;
		ProgressEfficiency = 0.8;
		Description = "The Wiifish is a legendary tropic fish that can only be found in the saltwaterâ€™s Sunstone Island during the day. They are an extremely old fish, dating back over 230,000,000 years ago. While the Wiifish is a slow swimmer, they can put up an immense fight for even advanced anglers.";
	...
	Ghoulfish = {
		...
		Seasons = {"None"};
		Weather = {"Clear"};
		Quips = {"A Ghoulfish!", "I caught a Ghoulfish!", "Woah! A Ghoulfish!", "Ouu! A Ghoulfish!", "what? there's nothing there..", "ðŸ‘»ðŸ‘»ðŸ‘»"};
		SparkleColor = Color3.fromRGB(255, 255, 255);
		HoldAnimation = fish:WaitForChild("basic");
